...
import BleDevice from "../utils/ble-web";
      ...
      <>
        <RoomEntryModal
          ...
          onBTConnect={async () => {
            ...
            const isConnected = await bleDevice.connectAndSetUp();
            console.log("Bluetooth connection status: ", isConnected);
            if (isConnected) {
              console.log("Bluetooth is connected");
              await bleDevice.writeData("A\n");
              console.log("Bluetooth data written");
              return;
            }
            console.log("Failed to connect to bluetooth device");
          }}
        />
